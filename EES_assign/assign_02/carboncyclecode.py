...
def create_interactive_analysis():
    ...
    while True:
        print("\nAmazon Carbon Cycle Analysis: ")
        print("Hit 1 to View Basic Statistics")
        print("Hit 2 to Show Trends Graphs")
        print("Hit 3 to View Future Predictions")
        print("Hit 4 to Calculate Supply Days")
        print("Hit 5 to Analyze Mitigation Strategies")
        print("Hit 6 to Exit")
