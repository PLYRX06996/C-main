...
int largestEven(Node *head)
{
    ...
    int current_pos = 1;
    // if (head == NULL)
    //     return INT_MAX; --> Memory corruption or crashe
    while (current != NULL)
    {
        if (current->data % 2 == 0 && current->data > max_even)
        {
...
int largestOdd(Node *head)
{
    ...
    int current_pos = 1;
    // if (head == NULL)
    //     return INT_MAX; --> Memory corruption or crashes
    while (current != NULL)
    {
        if (current->data % 2 != 0 && current->data > max_odd)
        {
    ...
    while (tc--)
    {
        ...
        while (true)
        {
            ...
            if (posOdd != -1)
            {
                ...
                // if head not updated properly -> undefined behaviour OR memory issues
            }
            if (head == NULL)
                break;
        }
